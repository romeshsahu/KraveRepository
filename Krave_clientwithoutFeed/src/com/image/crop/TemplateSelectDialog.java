...
public class TemplateSelectDialog extends Activity {
    ...
    public static final String[] FACE_TEMPLATE_TEXT = new String[] {
    	"Rectangular Shape", "Oblong Face", "Oval Face", "Round Face",
    	"Square Face", "Triangular Face" };
    public static final Integer[] FACE_TEMPLATE_IMAGE = new Integer[] {
    		R.drawable.shape_rectangular, R.drawable.face_oblong,
    		R.drawable.face_oval, R.drawable.face_round,
    		R.drawable.face_square, R.drawable.face_triangular };
