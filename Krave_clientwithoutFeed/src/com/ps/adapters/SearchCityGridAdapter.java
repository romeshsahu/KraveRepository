...
public class SearchCityGridAdapter extends BaseAdapter {
	...
	public SearchCityGridAdapter(Context Activity, List<UserDTO> arrayList,
			boolean fromSearchCity) {
	...
	public int getCount() {
		...
		return filteredData.size();// isOnlineOnly?onlineData.size():filteredData.size();
	}

	@Override
	public Object getItem(int position) {
		return filteredData.get(position);// isOnlineOnly?onlineData.get(position):filteredData.get(position);//
											// /[position];
	}
