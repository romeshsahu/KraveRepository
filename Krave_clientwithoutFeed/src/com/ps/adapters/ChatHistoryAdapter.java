...
public class ChatHistoryAdapter extends BaseAdapter{
	Context mActivity;
	ArrayList<ChatHistoryDTO> marrayList;
	int check;

	public ChatHistoryAdapter(Context Activity,
			List<ChatHistoryDTO> arrayList, int check) {
		this.mActivity = Activity;
		this.marrayList = (ArrayList<ChatHistoryDTO>) arrayList;
		this.check = check;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.mTextView.setText(marrayList.get(position).getChatHistoryName());
		return rowView;
	}
}
